...
sample_data = sample_get_cache_itunes_data("Taylor Swift",media_term="all")
# print(json.dumps(sample_data))
test_diction = sample_data ['results'][0]
...
media_samples = sample_get_cache_itunes_data("love")["results"]#list of dictionaries with all media with the word love

song_samples = sample_get_cache_itunes_data("love","music")["results"] #list of dictionaries with all songs with the word love

movie_samples = sample_get_cache_itunes_data("love","movie")["results"] #list of dictionaries with all movies with the word love
